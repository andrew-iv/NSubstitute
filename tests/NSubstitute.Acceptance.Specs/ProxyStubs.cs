...
namespace NSubstitute.Acceptance.Specs
{
    public class ProxyStubs
    {
        ...
        {
            var obj = new TestInterfaceImpl();
            var proxyMock = Substitute.ForProxy<ITestInterface>(obj);
            Assert.That(proxyMock.TestMethodReturnsInt(), Is.EqualTo(1));
            proxyMock.Received(1).TestMethodReturnsInt();
            proxyMock.Received(1).TestMethodReturnsInt();
            Assert.That(proxyMock.TestMethodReturnsInt(), Is.EqualTo(2));
            proxyMock.Received(2).TestMethodReturnsInt();
        }
        ...
        public class TestInterfaceImpl: ITestInterface
        {
            ...
            public int TestMethodReturnsInt()
            {
                CalledTimes++;
                return CalledTimes;
            }
